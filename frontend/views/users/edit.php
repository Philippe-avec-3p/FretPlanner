        ...
        <header class="main-header">
            <div class="header-content">
                ...
                <div class="header-actions">
                    <a href="<?= $config['app']['url'] ?>/frontend/users/show?id=<?= $targetUser['id'] ?>" class="btn btn-secondary me-2">
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST" action="<?= $config['app']['url'] ?>/frontend/users/update">
                                ...
                                <div class="d-flex gap-2 mt-4">
                                    ...
                                    <a href="<?= $config['app']['url'] ?>/frontend/users/show?id=<?= $targetUser['id'] ?>" class="btn btn-secondary">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="d-grid gap-2">
                                ...
                                <a href="<?= $config['app']['url'] ?>/frontend/users/show?id=<?= $targetUser['id'] ?>" class="btn btn-outline-info btn-sm">
                                    <i class="fas fa-eye me-2"></i>
...
<script>
    ...
    function confirmDelete() {
        if (confirm('Êtes-vous sûr de vouloir supprimer définitivement cet utilisateur ?\n\nCette action est irréversible !')) {
            ...
            form.method = 'POST';
            form.action = '<?= $config['app']['url'] ?>/frontend/users/delete';
